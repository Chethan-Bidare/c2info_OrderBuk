...
public class TC_004_VerifyOrderClosedButton extends TestBase{

public static final Logger log = Logger.getLogger(TC_004_VerifyOrderClosedButton.class.getName());
