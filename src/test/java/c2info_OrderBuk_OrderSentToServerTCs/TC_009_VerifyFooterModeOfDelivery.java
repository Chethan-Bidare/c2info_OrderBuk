...
public class TC_009_VerifyFooterModeOfDelivery extends TestBase{

public static final Logger log = Logger.getLogger(TC_009_VerifyFooterModeOfDelivery.class.getName());
