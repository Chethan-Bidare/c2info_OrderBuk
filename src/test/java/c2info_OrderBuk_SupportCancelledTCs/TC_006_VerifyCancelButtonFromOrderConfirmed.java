...
public class TC_006_VerifyCancelButtonFromOrderConfirmed extends TestBase{

	
public static final Logger log = Logger.getLogger(TC_006_VerifyCancelButtonFromOrderConfirmed.class.getName());
