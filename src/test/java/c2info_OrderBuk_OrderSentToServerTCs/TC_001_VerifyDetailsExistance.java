...
public class TC_001_VerifyDetailsExistance extends TestBase{

	public static final Logger log = Logger.getLogger(TC_001_VerifyDetailsExistance.class.getName());
