...
public class TC_008_VerifyFooterModeOfPayment extends TestBase{

public static final Logger log = Logger.getLogger(TC_008_VerifyFooterModeOfPayment.class.getName());
