...
public class TC_009_VerifyViewPrescriptionButton extends TestBase{
	
	public static final Logger log = Logger.getLogger(TC_009_VerifyViewPrescriptionButton.class.getName());
	...
	public void verifyPrescriptionButton() throws InterruptedException{
		log.info("======= TC_009_VerifyViewPrescriptionButton Test Started ======");
	...
	public void verifyImageExistanceinPrescPopUp(){
		log.info("======= TC_009_VerifyViewPrescriptionImage Test Started ======");
		NewItemPutOnHold nph = new NewItemPutOnHold();
